          ...
          <div className="popularLocations">
            ...
            <table>
              <tr>
                <td width="60px">
                  <div className="icon">
                    <ion-icon name="location" className="loc-icon"></ion-icon>
                  </div>
                </td>
                <td>
                  <h4 style={{ color: "#eb4a42" }}>
                    <strong>Tibanga, Iligan City</strong> <br />{" "}
                    <span style={{ color: "#361d32" }}>50,000 commuters</span>
                  </h4>
                </td>
              </tr>
            </table>
